        ...
        <div className="py-12 md:py-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="mt-4 text-cream/70 text-sm leading-relaxed">
                Neighborhood coffee, roasted in-house.
                Portland, Oregon since 2018.
              </p>
            </div>
            ...
            <div>
              ...
              <address className="mt-4 not-italic text-sm text-cream/70 space-y-2">
                <p>3847 SE Division Street</p>
          ...
          <div className="mt-12 pt-8 border-t border-cream/10 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm text-cream/50">
              &copy; {new Date().getFullYear()} Ember & Oak Coffee. All rights reserved.
            </p>
